...
/*   Updated: 2025/05/02 01:40:21 by tdelage          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef t_u64	(*t_urand_f)(t_any, t_u64, t_u64);
typedef t_i64	(*t_irand_f)(t_any, t_i64, t_i64);
typedef void	(*t_srand_f)(t_any, t_u64);
...
void			random_set_seed(t_random *rand, t_seed seed);
t_u64			random_unsigned_value(t_random *rand, t_u64 a, t_u64 b);
t_i64			random_signed_value(t_random *rand, t_i64 a, t_i64 b);
